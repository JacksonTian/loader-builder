...
exports.checkTarget = function (scaned) {
  ...
  scaned.forEach(function (item) {
    ...
    if (item.type !== 'file' && targets.hasOwnProperty(item.target)) {
      throw new Error('Duplicate target: ' + item.target);
    }
